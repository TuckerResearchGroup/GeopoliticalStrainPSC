...
sets_df = pd.read_excel('Quality75_Data.xlsx', sheet_name='sets') 
...
F_df = pd.read_excel('Quality75_Data.xlsx', sheet_name='Fk') 
...
supplier_df = pd.read_excel('Quality75_Data.xlsx', sheet_name='I')
...
c_t1_df = pd.read_excel('Quality75_Data.xlsx', sheet_name='c_t1')
...
c_t2_df = pd.read_excel('Quality75_Data.xlsx', sheet_name='c_t2')
...
c1_2 = m_mp.addConstr(Y['USA'] == 1, "c1_2")    #USA must be selected
