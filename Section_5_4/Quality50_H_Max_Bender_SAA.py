...
sets_df = pd.read_excel('Quality50_Data.xlsx', sheet_name='sets')   
...
F_df = pd.read_excel('Quality50_Data.xlsx', sheet_name='Fk') 
...
supplier_df = pd.read_excel('Quality50_Data.xlsx', sheet_name='I')
...
c_t1_df = pd.read_excel('Quality50_Data.xlsx', sheet_name='c_t1')
...
c_t2_df = pd.read_excel('Quality50_Data.xlsx', sheet_name='c_t2')
